...
let IdCardsComponent = class IdCardsComponent {
    constructor(router, httpClient, prod_service) {
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("Prodl3Id")).subscribe((res) => {
            this.img_list = res;
        });
    }
...
let LoginComponent = class LoginComponent {
    constructor(user_service, _sharedservice, httpClient, prod_service, router) {
    ...
    submit() {
        ...
        if (user_name != "" && pwd != "") {
            this.httpClient.get(this.prod_service.getUrl() + 'api/Userdetail/' + user_name).subscribe(result => {
                ...
                if (email_exists == -1) {
                    ...
                    if (user_name == email && pwd == password) {
                        ...
                        if (localStorage.getItem('userid') != null) {
                            var s = "appPage";
                            this.httpClient.get(this.prod_service.getUrl() + 'api/OdCarts/' + localStorage.getItem("userid")).subscribe((res) => {
...
let RegisterComponent = class RegisterComponent {
    constructor(httpClient, prod_service, router, _userdetailService, baseUrl) {
        this.httpClient = httpClient;
        this.prod_service = prod_service;
        this.router = router;
    ...
    ngOnInit() {
        ...
        //--------HTTPGET REQUEST--------
        this.httpClient.get(this.prod_service.getUrl() + 'api/Secqmasters').subscribe((res) => {
            //this.secq.push(res);
            this.secq = res;
            var test = res;
            for (var i = 0; i <= 10; i++) {
    ...
    register() {
        ...
        this.httpClient.get(this.prod_service.getUrl() + 'api/Userdetail').subscribe(res => {
...
let AddressListComponent = class AddressListComponent {
    constructor(http, router, prod_service) {
        this.http = http;
        this.router = router;
        this.prod_service = prod_service;
        this.address_list = [];
    ...
    ngOnInit() {
        ...
        this.http.get(this.prod_service.getUrl() + 'api/Useraddresses/' + this.userid, { params: { action: "addr_lst" } }).subscribe((res) => {
    ...
    setUsersList() {
        this.http.get(this.prod_service.getUrl() + 'api/Useraddresses/' + this.userid, { params: { action: "addr_lst" } }).subscribe((x) => {
            this.address_list = x;
        });
    }
};
...
let AdminComponent = class AdminComponent {
    ...
    ngOnInit() {
        ...
        var prd_level = "p1";
        let prodid = 0;
        this.http.get(this.prod_service.getUrl() + 'api/Products/' + prd_level + '/' + prodid).subscribe((res1) => {
            p = res1;
            this.prod_lst = res1;
    ...
    OnFileSelect(event) {
        ...
        if (prodid_l3 != "") {
            this.http.get(this.prod_service.getUrl() + 'api/Productmodels/' + prodid_l3 + '/' + "adminpage").subscribe((e) => {
            ...
            this.http.get(this.prod_service.getUrl() + 'api/Productmodels/' + prodid_l2 + '/' + "adminpage").subscribe((e) => {
                model_count = e.length;
                selected_filename = $("#modle_code")[0].value + '_' + model_count + '.jpg'; // this.selectedfile.name;
                // alert(selected_filename);
                const newFile = new File([event.target.files[0]], selected_filename, { type: oldFileItem.type });
...
let AppComponent = class AppComponent {
    constructor(http, _location, prod_service, router, _sharedservice) {
        this.http = http;
    ...
    ngOnInit() {
        ...
        this.http.get(this.prod_service.getUrl() + 'api/Products').subscribe((res1) => {
            this.prodView = res1;
...
let CalenderComponent = class CalenderComponent {
    ...
    AddToCart() {
        if (localStorage.getItem("userid") != null) {
            ...
            var s = "l3menu";
            this.httpClient.get(this.prod_service.getUrl() + 'api/Orderdetails/' + sessionStorage.getItem('ModelId') + '/' + s).subscribe((res) => {
...
let cartComponent = class cartComponent {
    constructor(prod_service, httpClient, _sharedservice) {
        this.prod_service = prod_service;
        this.httpClient = httpClient;
        this._sharedservice = _sharedservice;
        this.cartItemCount = 0;
    ...
    ngOnInit() {
        ...
        //    }
        //});
        this.httpClient.get(this.prod_service.getUrl() + 'api/OdCarts/' + localStorage.getItem("userid")).subscribe((r) => {
            this.productAddedTocart = r;
            if (sessionStorage.getItem("ModelId") != null) {
                this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("ModelId") + '/' + "cart").subscribe((r) => {
                    this.img_list = r;
                });
            }
            else {
...
let EditAddressComponent = class EditAddressComponent {
    constructor(route, prod_service, http, formbuilder) {
        this.route = route;
        this.prod_service = prod_service;
        this.http = http;
    ...
    setForm(addrId) {
        this.http.get(this.prod_service.getUrl() + 'api/Useraddresses/' + addrId).subscribe((x) => {
            this.selectedAddr = x;
...
let ForgotpasswordComponent = class ForgotpasswordComponent {
    ...
    ngOnInit() {
        ...
        //HTTPGET Request
        this.http.get(this.prod_service.getUrl() + 'api/Secqmasters').subscribe((res) => {
            //this.secq.push(res);
            this.secq = res;
            var test = res;
            for (var i = 0; i <= 10; i++) {
    ...
    submit() {
        ...
        let user_name = $("#email").val();
        this.http.get(this.prod_service.getUrl() + 'api/Userdetail/' + user_name).subscribe(result => {
...
let HomeComponent = class HomeComponent {
    constructor(router, prod_service) {
        this.router = router;
        this.prod_service = prod_service;
    }
    redirect() {
...
let InvitationCardsComponent = class InvitationCardsComponent {
    ...
    ngOnInit() {
        ...
        if (sessionStorage.getItem("Prodl3Id") != "null") {
            this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("Prodl3Id") + '/' + "invi").subscribe((res) => {
                this.img_list = res;
            });
        }
        else {
            this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("Prodl2Id") + '/' + "invi").subscribe((res) => {
                this.img_list = res;
            });
        }
    }
    imgclick(e, f, g) {
        ...
        this.httpClient.get(this.prod_service.getUrl() + 'api/Productmaterials/' + levelid).subscribe((res) => {
            // this.prod_mat = res;
            res.forEach(e => {
        ...
        this.httpClient.get(this.prod_service.getUrl() + 'api/Productservices/' + levelid).subscribe((r) => {
            if (r.length == 0)
                $("#ddl_prodser").hide();
            else
                $("#ddl_prodser").show();
        ...
        $("#lbl_desc").text(g);
        sessionStorage.setItem('ModelId', e);
        this.httpClient.get(this.prod_service.getUrl() + 'api/Pricedetails/' + e).subscribe((res) => {
...
let VisitingCardsComponent = class VisitingCardsComponent {
    ...
    ngOnInit() {
        if (sessionStorage.getItem("Prodl3Id") != null) {
            this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("Prodl3Id") + '/' + "viscard").subscribe((res) => {
                this.img_list = res;
            });
        }
        else
            this.httpClient.get(this.prod_service.getUrl() + 'api/Productmodels/' + sessionStorage.getItem("Prodl2Id") + '/' + "viscard").subscribe((res) => {
                this.img_list = res;
            });
        $(document).ready(function () {
